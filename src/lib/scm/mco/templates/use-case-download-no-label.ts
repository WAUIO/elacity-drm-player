...
<http://mpeg.org/action2>
        a               mvco:distribute ;
        rdfs:label      "Digital Sale distributes a media" ;
        mvco:actedBy    <http://mpeg.org/DigitalSale> ;
        mvco:actedOver  <http://mpeg.org/Song> , <http://mpeg.org/Video> .
...
<http://mpeg.org/permission2>
        a                       mvco:Permission ;
        rdfs:label              "Aggregator authorises digital sale to sell a media" ;
        mco-core:issuedIn       <http://mpeg.org/contract6> ;
...
<http://mpeg.org/obligation2>
        a                         mco-core:Obligation ;
        rdfs:label                "Artist to provide a media to record label" ;
        mco-core:issuedIn         <http://mpeg.org/contract6> ;
        mvco:issuedBy             <http://mpeg.org/RecordLabel> ;
...
<http://mpeg.org/action1>
        a               mco-rele:Play ;
        rdfs:label      "Consumer plays a media" ;
        mvco:actedBy    <http://mpeg.org/Consumer> ;
        mvco:actedOver  <http://mpeg.org/Song> , <http://mpeg.org/Video> .
...
<http://mpeg.org/permission1>
        a                       mvco:Permission ;
        rdfs:label              "Consumer can play a media" ;
        mco-core:issuedIn       <http://mpeg.org/contract6> ;
        mvco:issuedBy           <http://mpeg.org/DigitalSale> ;
...
<http://mpeg.org/obligation1>
        a                         mco-core:Obligation ;
        rdfs:label                "Record label provide a media to digital sale" ;
        mco-core:issuedIn         <http://mpeg.org/contract6> ;
        mvco:issuedBy             <http://mpeg.org/Publisher> ;
...
<http://mpeg.org/action5>
        a               <mco-core:Provide> ;
        rdfs:label      "Streaming provides a media" ;
        mvco:actedBy    <http://mpeg.org/RecordLabel> ;
        mvco:actedOver  <http://mpeg.org/Song> , <http://mpeg.org/Video> .
...
<http://mpeg.org/contract6>
        ...
        mco-core:hasParty  <http://mpeg.org/DigitalSale> , <http://mpeg.org/Musicians> , <http://mpeg.org/RecordLabel> , <http://mpeg.org/SongWriter> , <http://mpeg.org/ArtistBand> , <http://mpeg.org/Publisher> , <http://mpeg.org/Consumer> .
...
<http://mpeg.org/action3>
        a               <mco-core:Provide> ;
        rdfs:label      "Record label provides a media" ;
        mvco:actedBy    <http://mpeg.org/ArtistBand> ;
        mvco:actedOver  <http://mpeg.org/Song> , <http://mpeg.org/Video> .

<http://mpeg.org/action9>
        a               mvco:distribute ;
        rdfs:label      "Digital Sale distributes media" ;
        mvco:actedBy    <http://mpeg.org/RecordLabel> ;
        mvco:actedOver  <http://mpeg.org/Song> , <http://mpeg.org/Video> .
...
<http://mpeg.org/permission9>
        a                       mvco:Permission ;
        rdfs:label              "Record label authorises aggregator a media" ;
        mco-core:issuedIn       <http://mpeg.org/contract6> ;
        mvco:issuedBy           <http://mpeg.org/RecordLabel> ;
